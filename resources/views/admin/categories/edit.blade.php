                ...
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-2">
                        ...
                        <li class="flex items-center">
                            ...
                            <span class="ml-2 text-gray-500">Edit Category</span>
                        </li>
                    </ol>
                </nav>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-md overflow-hidden">
                            <div class="p-4 flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-white">{{ $category->products_count ?? 0 }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg shadow-md overflow-hidden">
                            <div class="p-4 flex items-center">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-green-100">Total Orders</p>
                                    <p class="text-2xl font-bold text-white">{{ $category->orders_count ?? 0 }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-lg shadow-md overflow-hidden">
                            <div class="p-4 flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-white">${{ number_format($category->total_revenue ?? 0, 2) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
