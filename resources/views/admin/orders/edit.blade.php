                ...
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-2">
                        ...
                        <li class="flex items-center">
                            ...
                            <span class="ml-2 text-gray-500">Edit Order #{{ $order->id }}</span>
                        </li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="quantity" name="quantity" value="{{ old('quantity', $order->quantity) }}" min="1" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('quantity') border-red-300 text-red-900 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror" required>
                        @error('quantity')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="text" id="total_price_display" value="{{ number_format($order->total_price, 2) }}" class="pl-7 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md bg-gray-50" readonly>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <div class="flex items-center">
                                <input id="is_delivered" name="is_delivered" type="checkbox" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" {{ old('is_delivered', $order->is_delivered) ? 'checked' : '' }}>
